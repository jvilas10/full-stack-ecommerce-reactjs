...
const UploadProducts = ({onClose}) => {
  ...
  return (
    <div className='fixed w-full h-full bg-red-600 top-0 left-0 right-0 bottom-0 flex justify-center items-center bg-slate-200 bg-opacity-50'>
     ...
     <form className='grid p-4 overflow-y-scroll h-full pb-20'>
